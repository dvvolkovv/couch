...
export const metadata: Metadata = {
  title: "Тарифы для специалистов — Hearty",
  description:
    "Выберите тарифный план для работы психолога или коуча на платформе Hearty. Тариф Старт — бесплатно.",
};
...
const faqs = [
  ...
  {
    question: "Берёт ли Hearty комиссию с платежей клиентов?",
    answer:
      "Да, Hearty взимает комиссию 10% с каждого платежа клиента на тарифах Старт и Профессионал, и 7% на тарифе Бизнес. Комиссия покрывает обработку платежей и содержание платформы.",
  },
];
