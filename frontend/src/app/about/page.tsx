...
export const metadata: Metadata = {
  title: "О нас — SoulMate",
  description:
    "SoulMate — платформа для подбора психологов и коучей по совпадению ценностей с помощью искусственного интеллекта. Узнайте о нашей миссии и команде.",
};
      ...
      <section className="bg-gradient-hero" aria-labelledby="about-hero-heading">
        <div className="mx-auto max-w-container px-4 py-16 md:px-8 md:py-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-body-lg text-neutral-700">
            {"SoulMate создан с одной целью — помочь людям найти специалиста, с которым они действительно смогут работать"}
          </p>
        </div>
      </section>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-body-md text-neutral-700">
                {"SoulMate меняет это. Наш ИИ-консультант помогает понять ваш запрос и ценности — а затем находит специалиста, чей подход совпадает именно с вами. Не по рейтингу. Не по цене. По совпадению."}
              </p>
            </div>
        ...
        <div className="mx-auto max-w-container px-4 md:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-neutral-300 bg-white p-8 shadow-card">
              ...
              <p className="text-body-sm text-neutral-700">
                {"Платформа открылась для всех. Сегодня на SoulMate работают более 500 верифицированных психологов и коучей, а тысячи клиентов нашли специалиста по совпадению ценностей."}
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="mx-auto max-w-container px-4 md:px-8 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-body-lg text-neutral-700">
            {"Над SoulMate работает междисциплинарная команда: практикующие психологи, специалисты в области машинного обучения, UX-дизайнеры и разработчики. Мы объединились потому, что каждый из нас лично столкнулся с проблемой поиска «своего» специалиста."}
          </p>
